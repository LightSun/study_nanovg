...
public class CustomView extends View {
    ...
    private PathExtractor.Metrics m = new PathExtractor.Metrics();
    ...
    public CustomView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.pathExtractor = new PathExtractor("/sdcard/temp/chz.ttf");
        ...
        this.textPaint.setTypeface(Typeface.createFromAsset(context.getAssets(), "chz.ttf"));
